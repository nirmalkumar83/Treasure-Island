...
if choise1 == "left":
    choise2 = input(
        'You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for boat. type"swim" to swim across.').lower()
    if choise2 == "wait":
        # Game will continue
        choise3 = input(
        ...
        if choise3 == "red":
            ...
            print("You choose a room does'nt exist. GAME OVER")
    else:
        print("You got attacked by the trout. GAME OVER")
